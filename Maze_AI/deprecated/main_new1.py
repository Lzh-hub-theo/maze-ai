        ...
        for event in pygame.event.get():
            ...
            # 走到终点
                ...
                if event.key == pygame.K_RIGHT:
                    # 右边无墙
                    if(0 <= roomx < 5 and 0 <= roomy <= 5 and r_list[roomy][roomx+1] == 0):
                        x += room_size
                        roomx += 1 # 计房间数
                        steps += 1 # 计步
                        ...
                        screen.blit(user, (x, y))
                    # 右边有墙
                    elif (0 <= roomx < 5 and 0 <= roomy <= 5 and r_list[roomy][roomx+1] == 1):
                        # steps += 1
                        font1 = pygame.font.Font(None, 32)
                    ...
                    # 上边无墙
                    if (0 <= roomx <= 5 and 0 < roomy <= 5 and r_list[roomy-1][roomx] == 0):
                        y -= room_size
                        roomy -= 1
                        steps += 1
                        font1 = pygame.font.Font(None, 32)
                        ...
                        screen.blit(user, (x, y))
                    # 上边有墙
                    elif (0 <= roomx <= 5 and 0 < roomy <= 5 and r_list[roomy-1][roomx] == 1):
                        # steps += 1
                        font1 = pygame.font.Font(None, 32)
                        font2 = pygame.font.Font(None, 32)
                        screen.fill(color.White, (25, 0, 200, 25))
