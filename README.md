...
| `battle-city-cv/` | 通过OpenCV+Selenium为网页端坦克大战中各个种类的图像进行视觉识别 | ✅ |
...
2. **打坦克大战**（失败）- 尝试让AI在坦克大战游戏中自动导航和战斗，但是做到了视觉识别相关的功能逻辑
...
尝试通过OpenCV视觉识别 + Selenium控制来实现AI玩网页端的坦克大战游戏。
